...
if __name__ == "__main__":
    input_file_path = "resources/prompt_eval/replan_prompt_inputs_v2.json"
    prompt_info = {
        "system": "resources/prompts/v2/replanner_system_prompt_v2.jinja2",
        "user": "resources/prompts/v2/replanner_user_prompt_v2.jinja2",
    }
    model_info = {

...
def installed_resources_dir() -> Path:
    # easylocai is installed as a package and we need to locate the resources directory relative to it
    ...
    spec = importlib.util.find_spec("easylocai")
    if spec is None or spec.origin is None:
        raise RuntimeError("Cannot locate installed package 'easylocai'.")
